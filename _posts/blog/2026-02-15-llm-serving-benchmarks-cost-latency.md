---
layout: post
title: "論文解説: LLMサービング性能ベンチマーク: レイテンシ・スループット・コスト最適化の徹底比較"
description: "vLLM、TensorRT-LLM、SGLangなど10種類以上のLLMサービングシステムを、レイテンシ、スループット、コストの3軸で徹底比較したベンチマーク研究。Llama-3.1やQwen2.5を用いた実測により、vLLMが総合バランスに優れ、SGLangがマルチターン会話で優位、TensorR"
categories: [blog, paper, arxiv]
tags: [LLM, cost-optimization, observability, monitoring, inference]
date: 2026-02-15 22:03:01 +0900
source_type: arxiv
arxiv_id: 2410.18424
source_url: https://arxiv.org/abs/2410.18424
...
**タイトル**: LLMサービング性能ベンチマーク: レイテンシ・スループット・コスト最適化の徹底比較
**arXiv ID**: [2410.18424](https://arxiv.org/abs/2410.18424)
**対象読者**: 修士学生レベル（機械学習・LLMの基礎知識を持つエンジニア・研究者）

vLLM、TensorRT-LLM、SGLangなど10種類以上のLLMサービングシステムを、レイテンシ、スループット、コストの3軸で徹底比較したベンチマーク研究。Llama-3.1やQwen2.5を用いた実測により、vLLMが総合バランスに優れ、SGLangがマルチターン会話で優位、TensorRT-LLMがスループット最大化に適していることを実証。コストは「GPU時給×推論時間/処理トークン数」で計算し、最適なバッチサイズで10-50%のコスト削減を達成。
...
- [arXiv:2410.18424](https://arxiv.org/abs/2410.18424)
