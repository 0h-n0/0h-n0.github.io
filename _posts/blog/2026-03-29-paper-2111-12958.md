...
WACVはIEEE/CVFが主催するコンピュータビジョンの国際会議であり、CVPRやICCVと並ぶ主要会議の1つである。実用的なビジョン応用に焦点を当てる傾向があり、SDSSLのようなSSL手法の実践的改善が評価される場である。SDSSLは自己教師あり学習における自己蒸留の新しいアプローチとして採択されている。
