---
layout: post
title: "論文解説: プロンプト圧縮でトークン数40-60%削減: 文レベル符号化による高速LLM推論"
description: "プロンプトを文単位でエンコードし、重要度スコアリングでトップ40-60%を選択することで、トークン数を削減しながら品質を維持する手法。MMLU、GSM8K、HumanEvalで精度低下2-5%以内を保ち、推論速度1.5-2.5倍、コスト削減率40-60%を実現。GPT-4では$0.03/1Kトークン"
...
**タイトル**: プロンプト圧縮でトークン数40-60%削減: 文レベル符号化による高速LLM推論
**arXiv ID**: [2404.08189](https://arxiv.org/abs/2404.08189)
**対象読者**: 修士学生レベル（機械学習・LLMの基礎知識を持つエンジニア・研究者）

プロンプトを文単位でエンコードし、重要度スコアリングでトップ40-60%を選択することで、トークン数を削減しながら品質を維持する手法。MMLU、GSM8K、HumanEvalで精度低下2-5%以内を保ち、推論速度1.5-2.5倍、コスト削減率40-60%を実現。GPT-4では$0.03/1Kトークンが$0.012-0.018に低減。ただし圧縮に+50msのオーバーヘッドがあり、プロンプト再利用時のみ有効。
...
- [arXiv:2404.08189](https://arxiv.org/abs/2404.08189)
