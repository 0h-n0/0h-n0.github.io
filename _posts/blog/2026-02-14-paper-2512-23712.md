...
excerpt: "JSON出力の類似度を測定する新しいメトリクスSTEDと、複数世代にわたる一貫性スコアリングを組み合わせた包括的評価フレームワーク"
categories:
  - TechBlog
tags:
  - LLM
...
- **arXiv ID**: 2512.23712
- **URL**: <a href="https://arxiv.org/abs/2512.23712" target="_blank" rel="noopener noreferrer">arXiv:2512.23712</a>
...
- **arXiv**: <a href="https://arxiv.org/abs/2512.23712" target="_blank" rel="noopener noreferrer">STED and Consistency Scoring (arXiv:2512.23712)</a>
...
- **Instructor**: <a href="https://python.useinstructor.com/" target="_blank" rel="noopener noreferrer">Instructor - Structured LLM Outputs</a>
